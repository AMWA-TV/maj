 ...
 **********************************************************************
 *
 * $Id: MediaListAppend.java,v 1.3 2011/02/14 22:32:49 vizigoth Exp $
 *
...
/**
 * <p>Labels a method as one used to append an element to an {@linkplain TypeDefinitionVariableArray AAF-type variable
 * length array} of the given {@linkplain PropertyDefinition property} name. The labelled method should
 * have a signature like:</p>
 * 
 * <p><code>&nbsp;&nbsp;&nbsp;&nbsp;public&nbsp;void&nbsp;append</code>&lt;<em>propertyName</em>&gt;<code>(</code><br>
 * <code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code>&lt;<em>arrayElementType</em>&gt;<code>&nbsp;value)</code></p>
 * 
 * @author <a href="mailto:richard@portability4media.com">Richard Cartwright</a>
 * 
 * @see TypeDefinitionVariableArray
 * @see tv.amwa.maj.model.BWFImportDescriptor#appendUnknownBWFChunk(tv.amwa.maj.model.RIFFChunk)
 */

@Documented
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.METHOD)
public @interface MediaListAppend {

	/** Property name of the property this method appends elements to. */
	String value();
}
