 ...
 **********************************************************************
 *
 * $Id: MediaPropertyClear.java,v 1.3 2011/02/14 22:32:49 vizigoth Exp $
 *
...
/**
 * <p>Labels a method as one used to clear an {@linkplain TypeDefinitionSet AAF-type set} or
 * {@linkplain TypeDefinitionVariableArray variable size array}
 ...
 * @see tv.amwa.maj.model.Preface#clearDescriptiveSchemes()
 *
 */
...
public @interface MediaPropertyClear {

	/** Property name for a property that this methods clears. */
	String value();
}
