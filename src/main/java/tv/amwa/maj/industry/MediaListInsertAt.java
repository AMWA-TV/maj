 ...
 **********************************************************************
 *
 * $Id: MediaListInsertAt.java,v 1.3 2011/02/14 22:32:49 vizigoth Exp $
 *
...
/**
* <p>Labels a method as one used to insert an element at an index into an {@linkplain TypeDefinitionVariableArray AAF-type variable
...
* 
* <p><code>&nbsp;&nbsp;&nbsp;&nbsp;public&nbsp;void&nbsp;insert</code>&lt;<em>propertyName</em>&gt;<code>At(</code><br>
...
* @see tv.amwa.maj.model.BWFImportDescriptor#insertUnknownBWFChunkAt(int, tv.amwa.maj.model.RIFFChunk)
*
*/
...
public @interface MediaListInsertAt {

	/** Property name of the array this method inserts values into. */
	String value();
}
