 ...
 **********************************************************************
 *
 * $Id: MediaListPrepend.java,v 1.3 2011/02/14 22:32:49 vizigoth Exp $
 *
...
/**
 * <p>Labels a method as one used to prepend an element to an {@linkplain TypeDefinitionVariableArray AAF-type variable
...
public @interface MediaListPrepend {

	/** Property name of the property this method prepends elements to. */
	String value();
}
