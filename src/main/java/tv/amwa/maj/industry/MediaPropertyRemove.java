 ...
 **********************************************************************
 *
 * $Id: MediaPropertyRemove.java,v 1.3 2011/02/14 22:32:49 vizigoth Exp $
 *
...
/*
 * $Log: MediaPropertyRemove.java,v $
...
/**
 * <p>Labels a method as one used to remove an element from an {@linkplain TypeDefinitionSet AAF-type set} 
 * for the {@linkplain PropertyDefinition property} of the given name. The labelled method should
 * have a signature similar to:</p>
 * 
 * <p><code>&nbsp;&nbsp;&nbsp;&nbsp;public&nbsp;void&nbsp;remove</code>&lt;<em>propertyName</em>&gt;<code>(</code><br>
 * <code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code>&lt;<em>elementType</em>&gt;<code>&nbsp;value)</code></p>
 * 
 * @author <a href="mailto:richard@portability4media.com">Richard Cartwright</a>
 * 
 * @see TypeDefinitionSet
 * @see tv.amwa.maj.model.Preface#removeDescriptiveScheme(tv.amwa.maj.record.AUID)
 */

@Documented
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.METHOD)
public @interface MediaPropertyRemove {
	
	/** Property name of the property the method removes an element from. */
	String value();
