 ...
 **********************************************************************
 *
 * $Id: DataBuffer.java,v 1.6 2011/01/04 10:42:32 vizigoth Exp $
 *
...
/** 
 * <p>Labels a buffer of data (octet data), represented as a Java <code>byte[]</code>.
 * This is used by to label byte arrays that are used to provide access to arrays of
 * byte data where the kind of that data is unknown.</p>
 * 
 * <p>
 * Original C name: <code>aafDataBuffer_t</code><br>
