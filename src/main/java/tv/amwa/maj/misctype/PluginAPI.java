 ...
 **********************************************************************
 *
 * $Id: PluginAPI.java,v 1.4 2011/01/04 10:42:32 vizigoth Exp $
 *
...
/** 
 * <p>Labels an {@linkplain tv.amwa.maj.record.AUID AUID} that identifies the plugin interface 
 * supported by a plugin.</p>
 * 
 * <p>
 * Original C name: <code>aafPluginAPI_t</code><br>
