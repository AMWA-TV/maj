...
/** 
 * <p>Labels an array of 64-bit unsigned integer values. This annotation is used
 * to show that a Java <code>long[]</code> is being used to represent an AAF 
 * <code>UInt64Array</code> type value.</p>
 * 
 * @see UInt64
 * 
